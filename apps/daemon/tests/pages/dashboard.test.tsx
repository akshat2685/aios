...
import * as PageModule from '@/pages/dashboard';
...
vi.mock('@/lib/electron-api', () => ({
  getElectronAPI: () => ({
    ...
    memory: { stats: vi.fn().mockResolvedValue({ vectors: 0, points: 0, collections: 0 }), list: vi.fn().mockResolvedValue([]) },
