...
import { WhisperSTT, LocalTTS } from '../offline-ai/src/speech-services';
import { AudioProcessor } from '../offline-ai/src/audio-processor';
import { VoiceRecorder } from '../offline-ai/src/voice-recorder';
import { ToolRegistry } from '../sandbox/src/registry';
